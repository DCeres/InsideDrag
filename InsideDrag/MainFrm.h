...
{
public:
	CMainFrame(): m_doc(*this){};

	DECLARE_FRAME_WND_CLASS(NULL, IDR_MAINFRAME)

	CInsideDragView* m_view;
	...
	BEGIN_MSG_MAP(CMainFrame)
		...
		MESSAGE_HANDLER(WM_VIEWHEX, OnViewHex)
...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	LRESULT OnViewHex(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled);
